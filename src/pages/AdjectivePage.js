...
const AdjectivePage = (props) => {
  ...
  console.log("English: " + adj.english);
  console.log("Spanish: " + adj.spanish);
  console.log("English Alt: " + adj.englishalt);
  console.log("English Alt 2: " + adj.englishalt2);
  console.log("Spanish Alt: " + adj.spanishalt);
  console.log("Spanish Alt 2: " + adj.spanishalt2);
  console.log("Russian: " + adj.russian);
  console.log("Latinized Russian: " + adj.russianlatin);
  console.log("Latinized Russian Alt: " + adj.russianlatinalt);
  console.log("Level: " + adj.level);
  console.log("-------------------------------------------");
